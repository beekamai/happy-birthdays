...
const ru: Record<string, string> = {
  ...
  "dashboard.reorderHint": "Перетаскивай карточки, чтобы изменить порядок",
  ...
  "editor.translation.hint": "Авторские поля на текущем языке, тут — второй язык. Пустые поля бэк до-переведёт сам при сохранении.",
  "editor.translation.translate": "🔄 Перевести автоматически",
...
const en: Record<string, string> = {
  ...
  "dashboard.reorderHint": "Drag cards to reorder",
  ...
  "editor.translation.hint": "Author fields are in the page language; here is the other language. The backend fills any empty fields on save.",
  "editor.translation.translate": "🔄 Translate automatically",
